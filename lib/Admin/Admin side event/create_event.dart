                      ...
                      if (input.length < 3 ||
                        ...
                        Get.snackbar('Opps', "Event name is Invalid.",
                            ...
                            backgroundColor:
                                const Color.fromRGBO(254, 109, 115, 1));
                        return '';
                      } else if (RegExp(r'\s{2,}').hasMatch(input)) {
                        Get.snackbar(
                            'Opps', "Event name contains multiple spaces",
                            colorText: const Color.fromARGB(255, 255, 255, 255),
                            backgroundColor:
                                const Color.fromRGBO(254, 109, 115, 1));
                      }
                ...
                myTextField(
                    ...
                    validator: (String input) {
                      ...
                      if (input.length < 3 ||
                        ...
                        Get.snackbar(
                            'Opps', "Location contains multiple spaces",
                            colorText: const Color.fromARGB(255, 255, 255, 255),
                            backgroundColor:
                                const Color.fromRGBO(254, 109, 115, 1));
                      }
                  ...
                  children: [
                    ...
                    iconTitleContainer(
                        ...
                        validator: (String input) {
                          ...
                          if (input.length >= 3) {
                            Get.snackbar(
                                'Opps', "Event can support max 99 entires only",
                                colorText:
                                    const Color.fromARGB(255, 255, 255, 255),
                                backgroundColor:
                                    const Color.fromRGBO(254, 109, 115, 1));
                          ...
                          if (RegExp(r'\s{1,}').hasMatch(input)) {
                            Get.snackbar('Opps', "Entires contains spaces",
                                colorText:
                                    const Color.fromARGB(255, 255, 255, 255),
                                backgroundColor:
                                    const Color.fromRGBO(254, 109, 115, 1));
