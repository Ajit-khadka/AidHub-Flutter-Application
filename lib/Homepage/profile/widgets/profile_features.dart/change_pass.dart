...
class ProfileForgetPass extends StatefulWidget {
  const ProfileForgetPass({super.key});

  @override
  State<ProfileForgetPass> createState() => _ProfileForgetPassState();
}
...
class _ProfileForgetPassState extends State<ProfileForgetPass> {
  @override
